...
function RunOfRunner() {
  ...
  return (
    <>
        ...
        <AppBar position="static" sx={{ backgroundColor: "#ff0000" }}>
          <Toolbar>
            ...
            <Typography variant="h5" component="div" sx={{ flexGrow: 1 }}>
              Run of Runner by Xenonz DTI-SAU
            </Typography>
      ...
      <Box sx={{ width: "100%" }}>
        <Box
          sx={{ width: "60%", boxShadow: 2, mx: "auto", my: 10, py: 5, px: 10 }}
        >
          <Typography
            variant="h5"
                    ...
                    <TableCell>
                      <Avatar
                        ...
                        src={
                          row.runImage === ""
                            ? Run
                            : `http://localhost:4444/images/runner/${row.runImage}`
                        }
